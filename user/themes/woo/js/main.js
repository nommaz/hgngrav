...
(function($) {
   ...
   ------------------------------------------------------ */
    ...
    var support_toggle_button = $("<span>", {
                        class: "support-open-mobile fa fa-phone" }
                        );

    nav_wrap.prepend(support_toggle_button);
...
jQuery(document).ready(function() {
    jQuery('.support-open, .support-open-mobile').on('click', function() {
        jQuery('.support-flyout').toggle();
    });

    jQuery('.support-close').on('click', function() {
        jQuery('.support-flyout').hide();
    });
});
